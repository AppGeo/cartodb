...
var debug = require('debug')('cartodb:tablebuilder');
...
// Key specific
'dropPrimary', 'dropUnique', 'dropIndex', 'dropForeign'].forEach(function (method) {
...
specialMethods.forEach(function (method) {
  TableBuilder.prototype[method] = function (value) {
    if (false) {
      debug('Knex only supports ' + method + ' statement with mysql.');
    }if (this._method === 'alter') {
      debug('Knex does not support altering the ' + method + ' outside of the create table, please use knex.raw statement.');
    }
